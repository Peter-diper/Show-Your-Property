  ...
  return (
    <div className="min-h-[66vh] animate-pulse">
      ...
      <section className="bg-gray-700 py-20 mb-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          <div className="w-full flex flex-col items-center">
            {/* Title */}
            <div className="h-13  w-3/4 bg-gray-600 rounded-lg mb-5" />

            {/* Description */}
            <div className="h-6 w-1/2 bg-gray-600 rounded mb-6" />
            ...
            <div className="mt-3 max-w-2xl w-full flex flex-col md:flex-row gap-4">
              ...
              <div className="h-12 bg-gray-500 rounded-lg w-full md:w-28" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-xl lg:container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            {[1, 2].map((item) => (
              <div
                key={item}
                className=" color-gradient-box-2 p-6 rounded-lg shadow-md"
              >
                <div className="h-8 w-56 bg-gray-900 rounded mb-4" />
      ...
      <section className="px-4 py-6">
        <div className="container-xl lg:container mx-auto">
          ...
          <div className="flex justify-center mb-6">
            <div className="h-10 w-72 bg-gray-900 rounded" />
          </div>
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="rounded-xl shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  {/* Title */}
                  <div className="h-7 w-4/5 bg-gray-900 rounded mb-6" />
                  ...
                  <div className="flex justify-center gap-4 mb-5">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="h-5 w-16 bg-gray-900 rounded" />
                    ))}
                  </div>
                  ...
                  <div className="flex justify-center gap-4 mb-5">
                    {[1, 2].map((i) => (
                      <div key={i} className="h-4 w-20 bg-gray-900 rounded" />
                    ))}
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="h-9 w-20 bg-gray-900 rounded-lg" />
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="m-auto max-w-lg  p-6">
        <div className="h-14 w-full bg-gray-900 rounded-xl" />
      </section>
    </div>
  );
}
